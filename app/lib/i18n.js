...
const EXACT_TEXT = new Map([
  ...
  ['שירות לקוחות: א׳-ה׳ 9:00-15:00 | משלוחים עד 10 ימי עסקים', 'Customer service: Sun-Thu 9:00-15:00 | Delivery up to 10 business days'],
  ['שירות לקוחות א׳-ה׳ 9:00-15:00 | משלוחים עד 10 ימי עסקים', 'Customer service Sun-Thu 9:00-15:00 | Delivery up to 10 business days'],
  ...
  ['משלוח עד 10 ימי עסקים', 'Delivery up to 10 business days'],
...
const TERM_TRANSLATIONS = [
  ...
  ['מחזורים', 'Machzorim'],
  ['סידורים', 'Siddurim'],
  ['מוסר ואמונה', 'Mussar and faith'],
  ['גמרות וש"ס', 'Gemara and Talmud sets'],
  ['הוצאות מובילות', 'Leading publishers'],
  ['סטים מהודרים', 'Deluxe sets'],
  ['מתנות והקדשות', 'Gifts and dedications'],
